<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="PhoneShop.User.Category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pcoded-inner-content pt-0">
        <div> <% Response.Write(Session["phonesAp"]); %> </div>
