<%@ Page Title="" Language="C#"  MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="PhoneShop.User.home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="food_section layout_padding">
        ...
        <li data-filter=".nokia">Nokia</li>
         <li data-filter=".berry">BlackBerry</li>
        <li data-filter=".tele">Telephone</li>
      </ul>
