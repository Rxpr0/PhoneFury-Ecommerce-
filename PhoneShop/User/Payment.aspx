<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="PhoneShop.User.Payment" %>
                        ...
                        <div class="card-header">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    ...
                                    <p class="text-muted">
                                        Note: At the end of recieving your order, you need to do full payment. 
